...
export const createThinkingAgentChain = (apiKey: string) => {
...
export const createDeveloperAgentChain = (apiKey: string) => {
  const model = createChatModel(apiKey);
...
export const createEditorAgentChain = (apiKey: string) => {
  const model = createChatModel(apiKey);
